...
EN = {
    ...
    "global_group_title": "Global Correction",
    "global_light_subheader": "Light",
    "global_color_subheader": "Color",
    "global_scope_info": "This panel's color correction is applied to the whole recomposed image, not to an individual channel.",
    "global_reset_tooltip": "Reset Global Correction",
    ...
    "crop_copy_tooltip": "Copy crop setting",
    ...
    "session_options_toolbar_tooltip": "Session Options",
    "session_options_dialog_title": "Session Options",
    "session_options_placeholder": "Session options are coming soon.",
    ...
    "settings_toolbar_tooltip": "Global Correction (E)",
    ...
    "dialog_locate_failed_text": (
        ...
        "affected photo(s) using the Independent Channels panel on the left."
    ),
    ...
    "menu_tools": "Tools",
    "menu_tools_trichrome": "Trichrome",
    "menu_tools_global_correction": "Global Correction",
    ...
    "menu_window_layout": "Layout",
    "menu_window_move_tool_to_left": "Move {tool} to Left Panel",
    "menu_window_move_tool_to_right": "Move {tool} to Right Panel",
    ...
    "independent_channels_group_title": "Independent Channels",
...
FR = {
    ...
    "global_group_title": "Correction Globale",
    "global_light_subheader": "Lumière",
    "global_color_subheader": "Couleur",
    "global_scope_info": "La correction de ce panneau s'applique à l'image recomposée dans son ensemble, pas à un calque individuel.",
    "global_reset_tooltip": "Réinitialiser la Correction Globale",
    ...
    "crop_copy_tooltip": "Copier les réglages de recadrage",
    "saturation_label": "Saturation",
    ...
    "session_options_toolbar_tooltip": "Options de la session",
    "session_options_dialog_title": "Options de la session",
    "session_options_placeholder": "Les options de session arrivent bientôt.",
    ...
    "settings_toolbar_tooltip": "Correction Globale (E)",
    ...
    "dialog_locate_failed_text": (
        ...
        "pour la ou les photos concernées, depuis le panneau Couches "
        "indépendantes à gauche."
    ),
    "dialog_locate_failed_column_photo": "Photo",
    ...
    "menu_tools": "Outils",
    "menu_tools_trichrome": "Trichromie",
    "menu_tools_global_correction": "Correction Globale",
    ...
    "menu_window_layout": "Disposition",
    "menu_window_move_tool_to_left": "Déplacer {tool} vers le panneau de gauche",
    "menu_window_move_tool_to_right": "Déplacer {tool} vers le panneau de droite",
    ...
    "independent_channels_group_title": "Couches indépendantes",
